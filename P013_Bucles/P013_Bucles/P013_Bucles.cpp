        ...
        case 1:
            ...
            if (apodo == apodo_usuario)
            {
                do
                {
                    ...
                    {
                        std::cout << "Bienvenido " << apodo << " solo para estar seguros, vuelve a entrar. " << std::endl;
                        do
                        {
                            std::cout << "Para confirmar tu acceso ingresa tu contraseña de nuevo: " << std::endl;
                            std::cin >> contra_usuario;
                            if (contra == contra_usuario)
                            {
